...
const Player = (props) => {
  const { songPlaying, selectedAlbum, playSong, pauseSong, nextSong,prevSong } = props

  return (
    <div id='player-container' className={songPlaying.id ? '' : 'hidden'}>
      <div id='player-controls'>
        <div className='row center'>
          <i className='fa fa-step-backward' onClick={() => prevSong(songPlaying, selectedAlbum)}></i>
